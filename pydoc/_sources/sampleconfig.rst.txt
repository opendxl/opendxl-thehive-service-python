...
TheHive DXL Python Service distribution contains a configuration file (``dxlclient.config``) located
...
The ``sample`` sub-directory also contains a service configuration file
(``dxlthehiveservice.config``) with settings specific to the APIs and event data
that the samples use. The ``[General]`` section in this file must be populated
with appropriate details for TheHive server configuration. For more details
on this configuration, see the

...
VERSION = __import__('dxlthehiveservice').get_version()
RELEASE_NAME = "dxlthehiveservice-python-dist-" + str(VERSION)
CONFIG_RELEASE_NAME = "dxlthehiveservice-python-dist-config-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxlthehiveservice")])
...
print("\nRemoving dxlthehiveservice.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxlthehiveservice.egg-info"))

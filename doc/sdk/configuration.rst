...
The TheHive DXL Python service library application requires a set of configuration files to operate.
...
TheHive DXL Python service library (dxlthehiveservice.config)
-------------------------------------------------------------
